...
@Component({ selector: 'app-past-auctions', standalone: true, imports: [CommonModule, RouterLink, PublicHeaderComponent], templateUrl: './past-auctions.component.html', styleUrl: './past-auctions.component.scss' })
